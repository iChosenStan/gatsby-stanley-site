    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        <section id="about-me">
            <SEO title="About Me" />
            <h1>Sobre mim</h1>
            <p>Olá eu sou Stanley, nas redes sociais como iChosenStan, técnico em programação Web, apaixonado por tecnologia.</p>
            
            <h3 className="mt-5">Educação</h3>
            <h4 className="mb-0 mt-3 font-bold">Programação de computadores ênfase WEB</h4>
            ...
            <h3 className="mt-5">Empreendedorismo & Hobbies</h3>
            <h4 className="mt-5">Co-Fundador, desenvolvedor e administrador</h4>
            ...
            <h4 className="mt-5">Fundador, desenvolvedor e administrador</h4>
            ...
            <h4 className="mt-5">Comunity Master</h4>
